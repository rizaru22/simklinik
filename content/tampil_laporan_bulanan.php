<script type="text/javascript" src="javascript/script_laporan_bulanan.js"> </script>
        ...
        <section class="invoice">
           ...
           <!-- <div class="spacer5"></div>-->
            ...
            <div class="row">
                ...
                echo '<button type="button" class="btn btn-warning btn-flat pull-right" style="margin-right: 5px;" onclick="cetak('.$tahun.','.$bulan.')"><i class="fa fa-print"></i> Cetak Laporan</button>';?>
                </div>
            </div>
        </section>
